  ...
  return (
    <form onSubmit={handleCalculate} autoComplete="off" className="space-y-3 group/form">
      ...
      <div className="group/field">
        <label htmlFor="orbit-altitude" className="block text-sm mb-1 text-gray-300 group-focus-within/field:text-purple-400 transition-colors">
      ...
      <div aria-live="polite" aria-atomic="true" className="min-h-[100px] flex flex-col">
        {formattedStats !== null ? (
          ...
          <div className="mt-4 flex-grow rounded border border-dashed border-white/10 group-focus-within/form:border-purple-500/30 flex items-center justify-center gap-2 text-gray-400 group-focus-within/form:text-purple-400 transition-colors duration-300 text-sm">
