  ...
  return (
    <form onSubmit={handleCalculate} className="space-y-3">
      ...
      <div>
        ...
        />
        <p id="rocket-m0-hint" className="text-xs text-gray-400 mt-1 peer-focus:text-cyan-400 transition-colors">Small: ~1,000kg, Medium: ~50,000kg, Heavy: ~500,000kg</p>
      </div>
      <div>
        ...
        />
        <p id="rocket-mf-hint" className="text-xs text-gray-400 mt-1 peer-focus:text-cyan-400 transition-colors">Typically 5-15% of initial mass (dry mass)</p>
      </div>
      <button
        type="submit"
